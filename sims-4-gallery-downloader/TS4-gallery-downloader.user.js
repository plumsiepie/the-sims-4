...
// @author      anadius (original), plumsiepie (adopted)
...
// @connect     plumsiepie.github.io
// @version     2.2.2
// @namespace   plumsiepie.github.io
// @grant       unsafeWindow
// @grant       GM.xmlHttpRequest
// @grant       GM_xmlhttpRequest
// @grant       GM.getResourceUrl
// @grant       GM_getResourceURL
// @icon        https://plumsiepie.github.io/the-sims-4/sims-4-gallery-downloader/sims-4-gallery-downloader.png
// @resource    bundle.json https://plumsiepie.github.io/the-sims-4/sims-4-gallery-downloader/bundle.min.json
...
// @note        2.2.2 - Fixed CORS error on bundle.json load; replaced fetch() with GM.xmlHttpRequest; bypassed GM.getResourceUrl in favour of direct URL fetch; self-hosted bundle.min.json on GitHub Pages after original host went offline
// ==/UserScript==
...
let jsonDescriptor = await xhr({
  url: 'https://plumsiepie.github.io/the-sims-4/sims-4-gallery-downloader/bundle.min.json',
  responseType: 'text'
});
jsonDescriptor = JSON.parse(jsonDescriptor);
